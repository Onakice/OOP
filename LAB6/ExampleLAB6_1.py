...
class ATM:
   ...
   def deposit(self,atm, account, money):
      if money > 0:
         ...
         account.transaction_list.append(Transaction('D-ATM',account.balance,'30-12-2023',atm.atm_id,account.account_id))
      return "Error"
   ...
   def withdraw(self, atm, account, money):
      if money > account.balance:
         ...
         account.set_balance -= money
         account.transaction_list.append(Transaction('W-ATM',account.balance,'30-12-2023',atm.atm_id,account.account_id))
   ...
   def transfer(self, atm, account1, account2, money):
      if money > account1.balance:
         ...
         account1.transaction_list.append(Transaction('T-ATM',account1.balance,'30-12-2023',atm.atm_id,account1.account_id))
         account2.transaction_list.append(Transaction('T-ATM',account2.balance,'30-12-2023',atm.atm_id,account2.account_id))
...
class Transaction:
   def __init__(self, type, balance, time, atm_id, account_id):
      self.__type = type
      self.__balance = balance
      self.__time = time
      self.__atm_id = atm_id
   ...
   def get_all_saction(self):
         saction = '-'.join(self.__data)
         return saction
