...
class ATM:
    ...
    def transfer(self, atm, account1, account2, money):
        ...
        return "Error class ATM def transfer 2"
...
class Transaction:
    ...
    # @property
    # def get_transaction(self, account, count):
    #     for transactions in account.transaction_list:
    #         if transactions == account.transaction_list[count]:
    #             print(self.__name, ":", transactions.type, ":", transactions.atm_id, "-", transactions.money, "-", transactions.balance)

    # def get_transaction(self, count):
    #     return f"{self.__type} : {self.__atm_id}-{self.__balance}"
    ...
    def __str__(self):
        ...
        #     return f"{self.__type} : {self.__account_id} via ATM {self.__atm_id}: -{self.__money}, Balance: {self.__balance}"
        elif self.__type == 'T-ATM':
            return f"{self.__type} : {self.__atm_id}- -{self.__money}-{self.__balance}"
        else:
...
atm1.insert_card(credit1, account1, 1234)
...
# for gettransaction in account2.transaction_list:
#     print("Hermione Transaction : ", gettransaction.get_transaction(gettransaction))

# for transactions in account2.transaction_list:
#     if transactions == account2.transaction_list[0]:
#         print("Hermione Transaction :", transactions.type, ":", transactions.atm_id, "-", transactions.balance) 
